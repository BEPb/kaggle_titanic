"""
Python 3.10 Advanced Feature Engineering with AdaBoostClassifier program with pre-processing of kaggle titanic competition data
File name: Feature_AdaBoostClassifier.py
...
single_best_model = AdaBoostClassifier(learning_rate= 0.1, n_estimators= 300, random_state= 0)

leaderboard_model = AdaBoostClassifier(learning_rate= 0.1, n_estimators= 300, random_state= 0)
...
submission_df.to_csv('29.submissions-0.748804.csv', header=True, index=False)

output = pd.read_csv('29.submissions-0.748804.csv')
...
print('Real score on submission: 0.748804')
