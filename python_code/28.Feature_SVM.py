"""
Python 3.10 Advanced Feature Engineering with Support Vector Machines program with pre-processing of kaggle titanic competition data
File name: Feature_SVM.py
...
output.to_csv('28.submission-fsvm-0.775119.csv', index=False)

# print(output)
output = pd.read_csv('28.submission-fsvm-0.775119.csv')
...
print('Percent: ', (result_df['percent'].value_counts('True')[0]))
print('Real score on submission: 0.775119')
