"""
Python 3.10 Decision Tree Classifier program with pre-processing of kaggle titanic competition data
...
output.to_csv('23.submission-dtc-0.715311.csv', index=False)
