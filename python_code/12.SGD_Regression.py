"""
Python 3.10 Stochastic Gradient Descent Regression program with pre-processing of kaggle titanic competition data
...
output.to_csv('12.submission-sgdr-0.6555.csv', index=False)
...
print('Real score on submission: 0.6555')
