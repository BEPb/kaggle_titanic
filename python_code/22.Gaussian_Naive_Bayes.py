"""
Python 3.10 Gaussian Naive Bayes program with pre-processing of kaggle titanic competition data
...
output.to_csv('22.submission-gmb-0.751196.csv', index=False)
...
print('Real score on submission: 0.751196')
