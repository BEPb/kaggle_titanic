"""
Python 3.10 Quantile Regression program with pre-processing of kaggle titanic competition data
File name: Quantile_Regression.py
...
output.to_csv('16.submission-hub-0.622.csv', index=False)
