"""
Python 3.10 Ridge regression program with pre-processing of kaggle titanic competition data
File name: Ridge_regression.py
...
output.to_csv('02.submission-ridge-0.65311.csv', index=False)
