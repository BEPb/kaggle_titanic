"""
Python 3.10 HuberRegressor program with pre-processing of kaggle titanic competition data
File name: HuberRegressor.py
...
output.to_csv('15.submission-hub-0.71052.csv', index=False)

print(output)
print('Correlation with ideal submission:', output['Survived'].corr(result_df['Survived']))
print('Real score on submission: 0.71052')
