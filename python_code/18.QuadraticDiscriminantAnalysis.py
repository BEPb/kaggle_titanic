"""
Python 3.10 QuadraticDiscriminantAnalysis program with pre-processing of kaggle titanic competition data
File name: QuadraticDiscriminantAnalysis.py
...
output.to_csv('18.submission-qda-0.746411.csv', index=False)
...
print('Real score on submission: 0.746411')