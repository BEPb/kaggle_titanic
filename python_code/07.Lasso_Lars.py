"""
Python 3.10 Lasso Lars program with pre-processing of kaggle titanic competition data
File name: Lasso_Lars.py
...
output.to_csv('07.submission-elastic-0.622.csv', index=False)
