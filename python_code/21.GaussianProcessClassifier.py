"""
Python 3.10 Gaussian Process Classifier program with pre-processing of kaggle titanic competition data
File name: GaussianProcessClassifier.py
...
output.to_csv('21.submission-gpc-0.767943.csv', index=False)
...
print('Real score on submission: 0.767943')
