"""
Python 3.10 Nearest Neighbors Classification program with pre-processing of kaggle titanic competition data
File name: Nearest_Neighbors_Classification.py
...
output.to_csv('20.submission-nnc-0.758373.csv', index=False)
...
print('Real score on submission: 0.758373')
