"""
Python 3.10 Passive Aggressive Classifier program with pre-processing of kaggle titanic competition data
File name: PassiveAggressiveClassifier.py
...
output.to_csv('14.submission-pac-0.53827.csv', index=False)
...
print('Real score on submission: 0.53827')
