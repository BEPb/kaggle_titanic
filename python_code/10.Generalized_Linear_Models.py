"""
Python 3.10 Generalized Linear Models program with pre-processing of kaggle titanic competition data
File name: Generalized_Linear_Models.py
...
output.to_csv('10.submission-gen-0.622.csv', index=False)
